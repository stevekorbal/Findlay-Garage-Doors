      ...
      <section className="bg-slate-900 text-white py-12 md:py-16 text-center">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight">
            Our Findlay Service Areas
          </h1>
          <p className="text-slate-300 text-xs md:text-sm leading-relaxed max-w-2xl mx-auto mt-4">
            We proudly serve homeowners, businesses, and property managers across Findlay, Hancock County, and surrounding Northwest Ohio communities. Our emergency dispatch fleets are stationed locally for rapid service.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 text-left">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-slate-600 text-xs md:text-sm mt-3 leading-relaxed">
            By stationing certified, friendly technicians in strategic regions across Hancock, Wood, Seneca, Allen, and Wyandot counties, we guarantee an average response time of under 45 minutes for urgent emergencies like broken high-tension springs or off-track doors.
          </p>
        </div>
