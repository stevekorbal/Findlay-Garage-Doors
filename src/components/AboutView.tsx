      ...
      <section className="bg-slate-900 text-white py-12 md:py-16 text-center">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight">
            About Findlay Garage Door Repair
          </h1>
          <p className="text-slate-300 text-xs md:text-sm leading-relaxed max-w-2xl mx-auto mt-4">
            A locally owned, community-first garage door company serving Findlay, OH, Hancock County, and Northwest Ohio with unmatched workmanship, safety, and upfront integrity.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs mt-1.5 leading-relaxed">
                We live and work in the Findlay and Hancock County area. We proudly support local charity events, community high school sports, and youth associations.
              </p>
            </div>
          </div>
