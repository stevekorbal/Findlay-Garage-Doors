        ...
        <div className="bg-white rounded-3xl p-6 md:p-10 border border-slate-200 shadow-sm text-xs md:text-sm text-slate-600 flex flex-col gap-6 leading-relaxed">
          {isPrivacy ? (
            <>
              ...
              <p>
                At Findlay Garage Door Repair, we value your privacy and trust. This Privacy Policy describes how we collect, use, process, and safeguard your personal information when you visit our website or submit inquiries through our online contact or request forms.
              </p>
            ...
            <>
              ...
              <p>
                By accessing this website, submitting request forms, or booking services with Findlay Garage Door Repair, you agree to be bound by these Terms & Conditions and all applicable state laws and regulations in Ohio.
              </p>

              <h2 className="text-lg font-extrabold text-slate-900 border-b border-slate-100 pb-2">2. Service Estimates & Scheduling</h2>
              <p>
                All on-site estimates prepared by our technicians are written and valid for 30 days from the inspection date. While we make every effort to arrive within our scheduled appointment windows, travel times may vary slightly due to Northwest Ohio weather conditions or road work. Our dispatch operators will always notify you of any delayed runs.
              </p>
              ...
              <p>
                Our technicians take great care to inspect wood framing and header structural integrity before adjusting springs. However, Findlay Garage Door Repair is not responsible for pre-existing structural rot or decay in wood jambs or framing that fails to support standard operating stress.
              </p>
            </>
          )}
        </div>
